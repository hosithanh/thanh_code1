...
export default function Trangchu(): JSX.Element {
    ...
    return (
        <div className='dashboard'>
                    ...
                    {useMemo(
                        () => (
                            <div className='chart'>
                                {truyCap && (
                                    <>
                                        <Bar height={180} data={truyCap} options={options} />
                                        <div className='luottruycap'>Lượt truy cập năm {moment().year()} </div>
                                    </>
                                )}
                            </div>
                        ),
                            ...
                            <div
                                ...
                                <List
                                    ...
                                    renderItem={(item: any, index) => (
                                        <List.Item key={index}>
                                            {/*  <List.Item.Meta avatar={<CaretRightOutlined />} title={<a href={`dulieu/chitiet?maDoiTuong=` + item.ma}>{item.ten}</a>} /> */}
            ...
            {/* <Spin size='large' className='loading-layout centerspin' tip='Đang tải dữ liệu' /> */}
        </div>
    )
}
